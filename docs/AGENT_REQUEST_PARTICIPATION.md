...
- `GET /requests?status=open` returns file-backed open request records from `data/audit-requests.json`
...
- this is a repo-side scaffold before `#217` and `#218`
- request discovery is file-backed rather than contract-event-backed
