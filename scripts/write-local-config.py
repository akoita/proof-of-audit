...
def main() -> None:
    ...
    parser.add_argument("--challenger-private-key", default="")
    ...
    api_env_values = {
        ...
        **(
            {"PROOF_OF_AUDIT_CHALLENGER_PRIVATE_KEY": args.challenger_private_key}
            if args.challenger_private_key
            else {}
        ),
    ...
    write_env_file(api_env_file, api_env_values)
