...
export PROOF_OF_AUDIT_ERC8004_IDENTITY_MODE="${PROOF_OF_AUDIT_ERC8004_IDENTITY_MODE:-official}"
export PROOF_OF_AUDIT_ERC8004_IDENTITY_REGISTRY="${PROOF_OF_AUDIT_ERC8004_IDENTITY_REGISTRY:-0x8004A818BFB912233c491871b3d84c89A494BD9e}"
